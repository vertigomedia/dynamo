...
instance DynamoAction CreateTable CreateTableResult
...
newtype DescribeTableResult = DescribeTableResult { dtStatus :: TableDescription }
    deriving (Show, A.FromJSON, Typeable)

------------------------------------------------------------------------------
-- | `DynamoAction` instance
instance DynamoAction DescribeTable DescribeTableResult
...
------------------------------------------------------------------------------
-- | `DynamoAction` instance
instance DynamoAction UpdateTable UpdateTableResult
...
------------------------------------------------------------------------------
-- | `DynamoAction` instance
instance DynamoAction DeleteTable DeleteTableResult
...
------------------------------------------------------------------------------
-- | `DynamoAction` instance
instance DynamoAction ListTables ListTablesResult
